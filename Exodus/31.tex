...
\begin{inparaenum}
    ...
    \verse{31:5} working in stone, for mounting,\ca{\missing\ \fragheb\septuagint}{missing in the Cairo Genizah and the Septuagint}\halot{uncertain: a) traditionally: abundance of water, pool; b) setting (of eyes, like jewels); c) of teeth, (firm) mounting} and for working in lumber~--- to do all kinds of work.%%
    ...
    \verse{31:8} and the table and its vessels\ca{\fragheb\ mlt Mss \sampen\septuagint\peshitta\ + \Hebrew{כל} cf \caref{}{30}{27\super{a}}}{the Cairo Genizah, multiple Hebrew manuscripts, the Samaritan Pentateuch, Septuagint, and Peshitta add ``all''; compare \vref{Ex}{30}{27\super{a}}} and the pure lampstand\halot{not candlestick} and all its vessels and the incense altar%%
    \verse{31:9} %%
    \verse{31:10} %%
    \verse{31:11} %%
