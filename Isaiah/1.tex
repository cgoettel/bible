...
\begin{inparaenum}
    ...
    \pvtt{Judge the fatherless;\footnote{orphans}}{learn to do good.}%%
    
    \pvot{\vn{1:18} I pray thee, come and let us reason together,''}{saith the \textsc{Lord}.}%%

    \pvtt{``If your sins are as scarlet,}{as snow they shall be white.}%%

    \pvtt{If they are blood\footnote{earth} red,}{they shall be as wool.\footnote{The dye that was used back then was permanent. The cloth could fade, but would never again be truly white.}}%%
    
    \pvot{\vn{1:19} If you're willing and hearken,}{you shall consume\footnote{eat of} the good of the land.}%%
