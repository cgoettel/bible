\heading{6}{Throne theophany and divine council~--- xxxx}

\begin{inparaenum}
    \verse{6:1} In the year King Uzziah, I saw the Lord sitting on a high and exalted throne, His flowing skirt filled the temple.%%
    ...
    \verse{6:7} He touched me on my mouth,\lit{He caused it to touch my lip}\ed{understood: with it} and said,%%
    ...
    \pvbb{\vn{6:10} Fatten the heart of this people,}{declare dull things in their ears, dazzle their eyes,}%%
    ...
    \fntlit{they turn back and have health.''}%%
    
    \pvac{\vn{6:11} And I said,}{``How long, Lord?''}{and He said,}%%
    
    \pvcb{``Until the cities}{are wasted without inhabitant.\footnotemark}%%
    ...
    \pvcb{Until\footnotemark\ houses are without people,}{the ground becomes a desolation.}%%
    \fnted{repeated}%%
    
    \pvbb{\vn{6:12} Until\footnotemark\ the \textsc{Lord} has placed man far away}{and the center\footnotemark\ of the land is greatly forsaken.}%%
    \fnted{repeated}%%
    \fntlit{heart}%%
    ...
    \pvca{so shall the holy seed\footnotemark\ be a stump.''\footnotemark}%%
