...
\begin{inparaenum}
  ...
  \smallskip
  \pa Thus says the Lord \textsc{God} to\alt{concerning} Edom:%%
  ...
  \pa \verse{1:8} On that day, shall I not,''\pa declares the \textsc{Lord},%%
  ...
  \pb \verse{1:15} because the day of the \textsc{Lord} is near\pa on all the nations.%%
