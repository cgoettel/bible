...
\begin{inparaenum}
    ...
    \verse{2:3} So she went and she came and gleaned behind the reapers. And it so happened that she came upon one of the fields allotted to Boaz (who is in Elimelech's extended family).%%
    \verse{2:4} %%
    \verse{2:5} %%
    \verse{2:6} %%
    \verse{2:7} %%
