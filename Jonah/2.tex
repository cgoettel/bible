...
\begin{inparaenum}
  ...
  \alt{in my despair/distress}%%
  
  \pvdb{I cried for help from the belly of Sheol}{and He heard my voice.}%%
  
  \pvcb{\verse{2:4} You cast me into the deep~--- into the midst of the sea~---}{and the rushing\footnotemark\ waters surrounded me.}%%
  \halot{xxxx}{xxxx deep?}%%
  
  \pvdb{All the billows and waves}{passed over me}%%
  
  \pvcb{\verse{2:5} and I said, `I am cast}{out of Your sight,}%%
  
  \pvdb{yet I will again look}{at Your holy temple.'\footnotemark}%%
  \lit{the temple of Your holiness}%%
  
  \pvcb{\verse{2:6} The waters encompassed me to my neck,}{the deep sea engulfed me.}%%
  
  \pvdb{The reeds\footnotemark\ were wrapped around my head}{\verse{2:7} I went down to the base of the mountains.}%%
  ...
  \pvcb{\verse{2:8} When my soul was faint}{I remembered the \textsc{Lord}.}%%
  
  \pvdb{My prayer came to You,}{to Your holy temple.}%%
  
  \pvcb{\verse{2:9} xxxx}{xxxx}%%
  
  \pvcb{\verse{2:10} With a voice of thanksgiving}{I will sacrifice to You.}%%
