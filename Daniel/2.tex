...
\begin{inparaenum}
    ...
    \verse{2:18} They requested compassion from before the God of the Heavens concerning the secret~--- that Daniel and his companions not be killed with of the wise men of Babylon.%%
    ...
    \pvab{\vn{2:22} He reveals deep\mpfootnotemark\ and hidden things.}{He knows what is in the darkness,}%%
    \footnotetext{KB: i.e., impenetrable}%%
    
    \pvba{and the light dwells with him.}%%
    
    \pvaa{\vn{2:23} You, God of my fathers, I praise and praise!}%%
