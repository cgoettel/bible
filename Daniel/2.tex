...
\begin{inparaenum}
  ...
  \verse{2:20} Daniel answered and said,\smallskip%%
  
  \pb Let the name of God\pa be blessed for ever and ever%%
  
  \pb Because wisdom and might are His!%%
  
  \pa \verse{2:21} He alters\pa times and seasons.\pa He removes kings\pa and appoints kings.%%
  
  \pb He gives wisdom to the wise\pa and knowledge to the insightful.\lit{knowledge/understanding to the knowledgeable [with] insight.}%%
  
  \pa \verse{2:22} He reveals deep%
  \halot{xxxx}{xxxx i.e., impenetrable}
  and hidden things.\pa He knows what's in the darkness,%%
  
  \pb and the light dwells with him.%%
  
  \pa \verse{2:23} You, God of my fathers, I praise%
  \ed{\textsc{ylt} and \textsc{darby} give ``thanking''; \textsc{halot} only gives ``praising.''}
  and praise!%%
