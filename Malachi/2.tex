...
\ed{``Malachi~2 is difficult because it doesn't make much sense.'' ---~Steven D.\ Ricks, 11 February 2015}

\begin{inparaenum}
  \pa \verse{2:1} Now, to you\pa is this commandment,\pa O priests:\smallskip%%
  
  \verse{2:2} ``If you don't listen, if you don't pay attention,\lit{lay it to heart} to give glory to My name,'' says the \lord\ of Hosts, ``I will send the curse\ie{for offering impure sacrifices} on you. I will curse your blessings. I have also cursed them because you're not paying attention.\smallskip%%
  ...
  \pc that My covenant may continue with Levi,''\pa says the \lord\ of Hosts.%%
  ...
  \pb \verse{2:12} The \lord\ will cut off from the tent of Jacob the man who does this, \Hebrew{עֵר}%
  ...
  \pa \verse{2:14} You've asked, `Why?'\pa Because the \lord\ has witnessed\pa between you and the wife of your youth%
  ...
  \ca{add?}{added? [``says the \lord, the God of Israel'']}%%
  ...
  \pa \verse{2:17} You've wearied the \lord\ with your words,\pa yet you say, `How\lit{In what} have we wearied Him?'\alt{You?'}%%
