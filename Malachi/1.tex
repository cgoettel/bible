...
\begin{inparaenum}
  ...
  \pvab{\verse{1:2} ``\thinspace`I have loved you,' says the \textsc{Lord}.}{Yet you say, `How have you loved us?'}%%
  
  \pvbd{`Isn't Esau Jacob's brother?'}{A declaration of the \textsc{Lord}.\footnotemark}{`I have loved Jacob}{\verse{1:3} and hated Esau.}%%
  ...
  \pvab{\verse{1:4} But Edom says, `We have been decimated,\footnotemark}{but we will return and rebuild the ruined sites,'\footnotemark}%%
  \alt{shattered}%%
  \alt{desolate places}%%
  ...
  \pvab{\verse{1:5} Your eyes have seen, and you shall say,}{`The \textsc{Lord} is exalted beyond the border of Israel.}%%
  
  \pvbb{\verse{1:6} A son honors his\footnotemark\ father,}{a servant his master.}%%
  \ed{understood}%%
  ...
  \pvbb{\verse{1:7} You have offered on My altar}{polluted\footnotemark\ bread.}%%
  \halot{xxxx}{(cultic) \textbf{pollution}}%%
  ...
  \pvbc{\verse{1:8} If you bring}{the blind\footnotemark to sacrifice~---}{there is no wrong in this.\footnotemark}%%
  \ie{a blind animal}%%
  \lit{isn't it evil?}%%
  
  \pvcc{If you bring}{the lame\footnotemark\ or ill~---}{there is no wrong in this.}%%
  \ed{could refer to an animal}%%
  ...
  \pvbb{\verse{1:9} `And now, please, appease\footnotemark}{God\footnotemark\ and He will graciously provide for us.}%%
  \alt{flatter, entreat}%%
  \lit{the face of God}%%
  ...
  \pvbb{\verse{1:10} `Who's even among you who would close the doors?\footnotemark}{You would not kindle on My altar without cause.\footnotemark}%%
  \ie{of the temple?}%%
  \alt{in vain.}%%
  ...
  \alt{oblation, sacrifice, allegiance}%%
  \lit{your hand.}%%
  
  \pvbb{\verse{1:11} \footnotemark because from sunrise to sunset}{My name is great among the nations.}%%
