...
\begin{inparaenum}
  ...
  \verse{1:13} You say, ``What a bother!'' and become enraged\lit{sniff} at it,'\ca{1 \Hebrew{אותִי} (Tiq soph)}{1 has ``at Me'' (the Tiqqun sopherim)} says the \lord\ of Hosts. `You've brought in stolen goods, the lame, and the sick, and you bring in your offering. Should I accept\alt{be please with} this from your hand?' says the \lord.\ca{frt ins c pc Mss \septuagint\peshitta\super{W} \Hebrew{צְבָאוֺת}}{perhaps insert ``of Hosts'' with a few Hebrew manuscripts, the Septuagint, and Peshitta}%%
