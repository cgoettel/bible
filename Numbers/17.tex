...
\begin{inparaenum}
    ...
    \verse{17:10} ``xxxx''%%
    \verse{17:11} Moses said to Aaron, ``Take the censor and put fire\ed{charcoal? halot xxxx} from the altar on it and place incense on it and go quickly to the congregation and perform\footnote{xxxx make?} an atonement for them because the wrath of the \textsc{Lord} has come out upon them. The plague has begun.''%%
    \verse{17:12} So Aaron took, just as Moses had said, and ran into the midst of the assembly and now\footnote{xxxx yeah?} the plague had begun. xxxx%%
