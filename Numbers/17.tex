...
\begin{inparaenum}
    ...
    \verse{17:10} ``xxxx''%%
    \verse{17:11} Moses said to Aaron, ``Take the censor and put fire\halot{xxxx} from the altar on it and place incense on it and go quickly to the congregation and make\halot{xxxx} an atonement for them because the wrath of the \textsc{Lord} has come out upon them. The plague has begun.''%%
