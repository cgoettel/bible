...
\begin{inparaenum}
    ...
    \verse{5:2} ``Command the people of Israel that they send everyone outside the camp who has a skin disease, a discharge,\halot{\textbf{mucous discharge} of a man (\textit{gonorrhea benigna}); \textbf{discharge of blood} of a woman (within and outside the menstrual period)} or who has become ritualistically unclean from coming in contact with\understood\ a corpse.%%
    ...
    \verse{5:7} they shall confess the sin that they've committed, he shall restore his wrong\halot{(equivalent amount of) \textbf{wrong} (in case of property damage)} by its total amount plus one fifth, and give it to the person he wronged.%%
    ...
    \verse{5:22} These cursed waters have come into your intestines and caused your belly\halot{of a man. Womb for a woman.} to swell and your crotch\halot{the fleshy portion of the \textbf{upper thigh}, seat of procreation, area of sexual organs.} to shrink. The woman shall say, ``Surely! Surely!''\ed{see Appendix~\ref{app:idioms}}%%
