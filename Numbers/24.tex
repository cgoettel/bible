...
\begin{inparaenum}
  ...
  \halot{xxxx}{[entry for \Hebrew{שְׁתֻם} has ``\haref{Nu}{24}{3$\cdot$15}: read \Hebrew{שְׂתֻם}. $\dagger$'' which entry reads:] \textbf{obstruct} (the way for something)\dots\ with closed eye \haref{Nu}{24}{3$\cdot$15}}
