...
\begin{enumerate}[align=center]
    ...
    \verse{Numbers^12:9} %
    \verse{Numbers^12:10} The cloud turned away from the tent\footnote{The Tabernacle. See Appendix~\ref{app:tabernacle}.} and Miriam was leprous\footnote{What is mentioned here as ``leprosy'' is a curable skin condition. See Appendix~\ref{app:psalm-110}.} as snow. Aaron turned to face Miriam and she was leprous.
    \verse{Numbers^12:11} Moses said, ``My \textsc{Lord}, please do not lay this sin upon us that we foolishly sinned.%
    \verse{Numbers^12:12} ''% NOTES FROM ORIGINAL TRANSLATION: stillborn. much like the appearance of the skin disease, typically rendered as ``leprosy.'' The idea of a malformed stillborn.
    \verse{Numbers^12:13} Moses cried unto the \textsc{Lord}, saying, ``Oh God, please heal her!''\footnote{\Hebrew{נָא} is used twice to emphasize Moses' plea.}%
    \verse{Numbers^12:14} So the \textsc{Lord} said to Moses, ``If her father had spat in her face, would she not be in disgrace for seven days? Let her be removed from the rest of the people and after that\footnote{Understood} she shall be received.''\footnote{We don't know why nothing happened to Aaron. Perhaps it's because he merely gave in to peer pressure (as he was wont to do).}%
    \verse{Numbers^12:15} Miriam was confined outside the camp for seven days, and the people did not travel until she was received back into the camp.%
    \verse{Numbers^12:16} Then the people up and left Hazeroth and camped in the desert of Paran.%
\end{enumerate}
