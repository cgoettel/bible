...
\begin{inparaenum}
  ...
  \pa ``Waheb%
  \ca{nonn Mss \Hebrew{אתוהב}; \septuagint\ \Greek{τὴν Ζωοβ} = \Hebrew{את־זָהָב} (cf~\caref{Dt}{1}{1}?), \peshitta\ \textit{\v slhbjt'} = \Hebrew{להב}}{several Hebrew manuscripts have \Hebrew{אתוהב} (xxxx?); the Septuagint has ``gold'' (compare~\vref{Deut}{1}{1}?), and the Peshitta has ``flame/blade''}
  ...
  \ca{pc Mss \septuagint(\peshitta) \Hebrew{עַד}; l \Hebrew{עָרֵי}}{a few manuscripts of the Septuagint (and Peshitta) had ``until'' [i.e., ``It has consumed up to Moab,'']; read ``the city of'' [i.e., ``It has consumed the city of Moab,'']}
