...
\begin{enumerate}[align=center]
    ...
    \verse{11:7} The manna was like coriander\footnote{Sp. \emph{cilantro}. However, this probably refers to the fruit (seed), not the leaves, and is referring to the taste, not its color.} and was the color of bdellium.\footnote{A tree resin varying from yellow to green, but usually a brown color.}%%
