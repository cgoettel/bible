...
\begin{inparaenum}
  ...
  \pc \verse{2:4} Now, be strong, Zerubbabel,' declares the \textsc{Lord}.%
  ...
  \pc \verse{2:6} For thus says the \textsc{Lord} of Hosts:\pa ``In just a little bit%
  ...
  \pc \verse{2:8} ``The silver is Mine, the gold is Mine,''\pa declares the \textsc{Lord} of Hosts.%%
  ...
  \pd ``I will create\lit{give} peace in this place,''\pa declares the \textsc{Lord} of Hosts.%%
  ...
  \pa before a stone was laid on a stone\pa in the house of the \textsc{Lord}. \verse{2:16} When%
  ...
  \pb \verse{2:20} The word of the \textsc{Lord} came to Haggai on the twenty-fourth day of the month,%%
  ...
  \pc \verse{2:23} In that day,' declares the \textsc{Lord} of Hosts, `I will take you,\pa Zerubbabel, son of Shealtiel, My servant,' the \textsc{Lord} declares,%
