...
\begin{inparaenum}
    ...
    \fntca{prb 1 \Hebrew{םִגְרָע} deminutio, al ins \Hebrew{נִגְרַע}}{probably one has ``diminished'' [probably ``Is the grain-pit yet diminished?''], while others insert ``diminish'' [i.e., ``Is the seed still diminished in the grain-pit?'']}%%
    ...
    \pvcb{`I am shaking}{the heavens and the earth.}%%
