...
\begin{inparaenum}
    ...
    \verse{7:16} He divided the three hundred men into three companies, and gave everyone a trumpet,\lit{gave a trumpet into the hand of everyone} an empty jar,\alt{pitcher}\halot{large (pottery) jar for flour or water} and a torch to put in it.%%
