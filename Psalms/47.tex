...
\begin{inparaenum}
  ...
  \ca{\missing\ pc Mss}{missing in a few Hebrew manuscript codices}
  with a shout of joy!%%
  ...
  \ca{pc Mss \Hebrew{לֵא׳}, Ms \septuagint\ \Hebrew{לֵאלֹהֵנוּ}}{a few Hebrew manuscript codices have the preposition \textit{to}, and a manuscript and the Septuagint have ``to our God''}
  Praise!%
  \ca{\peshitta\ \textit{b\v{s}wb\d{h}'} in splendore}{the Peshitta says ``in splendor'' [instead of ``Praise!'']}%%
  \pa Praise our King! Praise%
  \ca{\missing\ 2 Mss \peshitta}{missing in two Hebrew manuscript codices and the Peshitta}%%
  
  \pb \verse{47:8} because God is the king%
  \ca{mlt Mss + \Hebrew{עַל־}}{multiple Hebrew manuscript codices add ``on'' [making it ``God is king over the whole earth,'' ``of'' simply being understood by context]}
