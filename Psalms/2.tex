...
\begin{inparaenum}
  ...
  \ca{\fragheb\ mlt Mss \Hebrew{יהוה}; \septuagint\peshitta\ pr cop}{manuscripts in the Cairo Genizah as well as multiple manuscripts have the Tetragrammaton; the Septuagint and the Peshitta put it before the copula [so, right where it is in translation]}
  ...
  \pc \verse{2:11} Serve the \textsc{Lord} with fear%
