...
\begin{inparaenum}
  ...
  \fnted{Although \Hebrew{תָּמִים} can mean ``perfectly,'' it is more modest to here render it as ``uprightly.''}%%
  ...
  \fntca{2 Mss `\Hebrew{וְנ}, \septuagint\ \Greek{πονηρευόμενος}, \peshitta\ \textit{mrgzn'} irritator}{two manuscripts have ``and he honors,'' the Septuagint has ``doing evil,'' the Peshitta has ``he who irritates''}%%
