...
\begin{inparaenum}
  ...
  \ca{prb l c \fragheb\ mlt Mss \symmachus\ Hier \Hebrew{בהררי}}{probably read with the Cairo Genizah and multiple Hebrew manuscript codices from Symmachus' Greek translation of the Old Testament and Hieronymus give \Hebrew{הרר} [instead of \Hebrew{הדר}]}%
  ...
  \ca{\fragheb\ mlt Mss \Hebrew{יהוה}}{multiple Hebrew manuscript codices from the Cairo Genizah have the Tetragrammaton}
  ...
  \ca{\fragheb\ \Hebrew{ראשׁי}, 2 Mss \peshitta\ \Hebrew{רֹאשׁוֺ}, 3 Mss + \Hebrew{הללויה} (2 Mss om in 111,1)}{The Cairo Genizah contains ``my head,'' two Hebrew manuscript codices of the Peshitta which have ``his head,'' and three Hebrew manuscript codices that include ``Hallelujah'' (two of which omit it in \vref{Ps}{111}{1})}%%
\end{inparaenum}
