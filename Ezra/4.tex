...
\begin{inparaenum}
    \verse{4:1} Judah and Benjamin's oppressors\footnote{alt., adversary, enemy, foe} head that the exiles\footnote{lit., children of the exiles} were building a temple for the \textsc{Lord}, the God of Israel.%%
    \verse{4:2} %% xxxx: check punctuation preceding this.
    \verse{4:3} %%
    \verse{4:4} %%
    \verse{4:5} %%
    \verse{4:6} %%
