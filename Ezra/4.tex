...
\begin{inparaenum}
  \verse{4:1} Judah and Benjamin's oppressors\alt{adversary, enemy, foe} heard that the exiles\lit{children of the exiles} were building a temple for the \lord, the God of Israel,%%
  ...
  \verse{4:3} Zerubbabel, Jeshua, and the chief fathers of Israel said to them, ``It's not for you, but for us, to build a house to our God, because only we\alt{we alone} shall build to the \lord\ God of Israel, as was commanded by King Cyrus, king of Persia.''%%
