...
\renewcommand\labelenumi{\hspace*{0.25em}\color{Blue}{[\hspace*{0.1em}\arabic{enumi}\hspace*{0.1em}]}}
...
\newcommand\vn[1]{%
    \markboth{#1}{#1}
    \hspace*{0.25em}\color{Blue}{[\hspace*{0.1em}\BehindSubString{:}{#1}\hspace*{0.1em}]}~%
...
\newcommand\pvoo[1]{#1}
\newcommand\pvot[2]{\begin{align*}\text{#1}\ \ \ \ \text{#2}\end{align*}}
\newcommand\pvoh[3]{#1\ \ \ \ #2\ \ \ \ #3}
\newcommand\pvof[4]{#1\ \ \ \ #2\ \ \ \ #3\ \ \ \ #4}
\newcommand\pvto[1]{\ \ \ \ #1}
\newcommand\pvtt[2]{\ \ \ \ #1\ \ \ \ #2}
\newcommand\pvth[3]{\ \ \ \ #1\ \ \ \ #2\ \ \ \ #3}
\newcommand\pvtf[4]{\ \ \ \ #1\ \ \ \ #2\ \ \ \ #3\ \ \ \ #4}
\newcommand\pvho[1]{\ \ \ \ \ \ \ \ #1}
\newcommand\pvht[2]{\ \ \ \ \ \ \ \ #1\ \ \ \ #2}
\newcommand\pvhh[3]{\ \ \ \ \ \ \ \ #1\ \ \ \ #2\ \ \ \ #3}
\newcommand\pvhf[4]{\ \ \ \ \ \ \ \ #1\ \ \ \ #2\ \ \ \ #3\ \ \ \ #4}
\newcommand\pvfo[1]{\ \ \ \ \ \ \ \ \ \ \ \ #1}
\newcommand\pvft[2]{\ \ \ \ \ \ \ \ \ \ \ \ #1\ \ \ \ #2}
\newcommand\pvfh[3]{\ \ \ \ \ \ \ \ \ \ \ \ #1\ \ \ \ #2\ \ \ \ #3}
\newcommand\pvff[4]{\ \ \ \ \ \ \ \ \ \ \ \ #1\ \ \ \ #2\ \ \ \ #3\ \ \ \ #4}
