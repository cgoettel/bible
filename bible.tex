...
\usepackage[paperwidth=5.75in, paperheight=8in, top=1in, bottom=1in, left=0.5in, right=0.5in]{geometry} % The size of Virginia Tufte's Syntax as Style
...
% Hoefler text
\usepackage{fontspec}
\setmainfont[BoldFont={HoeflerText-Bold},ItalicFont={Hoefler Text Italic},BoldItalicFont={Hoefler Text Black Italic},SmallCapsFont={HoeflerText-RomanSC},Ligatures={NoCommon}]{Hoefler Text}
\newfontface\fancy{HoeflerTitling-HTF-LtSwash}
