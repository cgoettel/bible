...
\newcommand\vn[1]{%
    \markboth{#1}{#1}
    \thinspace\color{Red}{$\!\!\!^{\BehindSubString{:}{#1}}$\thinspace}%
...
\newcommand\pvab[2]{\noindent\hspace*{1em}#1\hspace*{1em}#2}
\newcommand\pvac[3]{\noindent\hspace*{1em}#1\hspace*{1em}#2\hspace*{1em}#3}
\newcommand\pvad[4]{\noindent\hspace*{1em}#1\hspace*{1em}#2\hspace*{1em}#3\hspace*{1em}#4}
\newcommand\pvba[1]{\noindent\hspace*{2em}#1}
\newcommand\pvbb[2]{\noindent\hspace*{2em}#1\hspace*{1em}#2}
\newcommand\pvbc[3]{\noindent\hspace*{2em}#1\hspace*{1em}#2\hspace*{1em}#3}
\newcommand\pvbd[4]{\noindent\hspace*{2em}#1\hspace*{1em}#2\hspace*{1em}#3\hspace*{1em}#4}
\newcommand\pvca[1]{\noindent\hspace*{3em}#1}
\newcommand\pvcb[2]{\noindent\hspace*{3em}#1\hspace*{1em}#2}
\newcommand\pvcc[3]{\noindent\hspace*{3em}#1\hspace*{1em}#2\hspace*{1em}#3}
\newcommand\pvcd[4]{\noindent\hspace*{3em}#1\hspace*{1em}#2\hspace*{1em}#3\hspace*{1em}#4}
\newcommand\pvda[1]{\noindent\hspace*{4em}#1}
\newcommand\pvdb[2]{\noindent\hspace*{4em}#1\hspace*{1em}#2}
\newcommand\pvdc[3]{\noindent\hspace*{4em}#1\hspace*{1em}#2\hspace*{1em}#3}
\newcommand\pvdd[4]{\noindent\hspace*{4em}#1\hspace*{1em}#2\hspace*{1em}#3\hspace*{1em}#4}
