...
\usepackage[paperwidth=5.75in, paperheight=8in, top=1in, bottom=1in, left=0.5in, right=0.5in]{geometry} % This is an abomination. The page height needs to be a bit longer, but it can't be because there are too many footnotes. Fix that bug, then fix this.
