...
% To indicate when a word used in English rendering is understood from the Hebrew, but not explicitly stated.
\usepackage[mathscr]{euscript}
\newcommand\understood{\textdegree\marginpar{~~~~$\mathscr{U}$~~~~}}
