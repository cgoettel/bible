...
\begin{inparaenum}
    ...
    \verse{6:3} The Ark of God rode on a new wagon.\halot{not a chariot.} They lifted it up from Abinadab's house in Gibeah. Uzzah and Ahio, Abinadab's sons, led the new wagon.%%
    \verse{6:4} They carried the Ark of God from Abinadab's house on the hill, Ahio going before the Ark.%%
    \verse{6:5} David and the Israelites played \lit{with}all kinds of instruments\understood\ before the \textsc{Lord}, instruments\understood\ of juniper wood,\halot{Phoenician juniper, \textit{Juniperus phoenicea} (tree \& wood).} lyres,\alt{harp} harps, drums, sistrums,\halot{small percussion instrument which is rattled.} and cymbals.%%
    ...
    \verse{6:20} David returned to bless his house and Saul's daughter, Michal, went out to call on David, and said, ``How magnificent\ed{xxxx: check if we can justify this rendering instead of ``honorable.''} was the king of Israel today that he exposed himself today in front of\lit{in the eyes of} his servants' handmaids, just how\alt{like, as} an uncovered, vain person is exposed.''%%
    ...
    \end{inparaenum}%%
    . It seems that David is saying that he is humbling himself, yet \textsc{darby} renders it as ``I will make myself yet more vile than thus'' and \textsc{ylt} renders it as ``I have been more vile than this.'' In essence, however, \Hebrew{קלל} means ``to humble oneself.''} than this. In my opinion, I've been lower.\halot{in social respect} I will be honored along with the handmaids you've referred to.''\lit{spoken of}%%
