...
\begin{inparaenum}
    ...
    \pvbb{``Does the \textsc{Lord} delight in sacrifices and burnt offerings}{as much as He delights in hearkening to the voice of the \textsc{Lord}?}%%
    
    \pvbb{Listen! Obedience is better than sacrifice.}{Paying attention is more important than ram's fat.}%%
    
    \pvab{\vn{15:23} Since rebellion is like the sin of witchcraft}{and stubbornness is like idolatry.}%%
    
    \pvbb{Because you've rejected the word of the \textsc{Lord},}{He has rejected you from being king.}%%
    ...
    \verse{15:25} Please forgive me\footnote{lit., Now, please bear my sin} and come with me as I bow down before the \textsc{Lord}.''%%
    \verse{15:26} Samuel said to Saul, ``No, I'm not going with you\footnote{lit., I will not turn back with thee} because you've rejected the word of the \textsc{Lord} and because the \textsc{Lord} hath rejected you from being king over Israel.''%%
