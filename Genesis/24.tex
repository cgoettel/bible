\heading{24}{Abraham commands his servant to find a wife for his son~--- the servant prays for help finding a wife for Isaac, and meets Rebecca~--- he recounts the story to Rebecca's brother Laban~--- xxxx}
...
\begin{inparaenum}
    ...
    \verse{24:21} The man stood gazing\ca{1 \Hebrew{משׁתעֶה}?}{1 has ``looked with favor at''?} at her, keeping quiet to know if the \textsc{Lord} had brought his way to a successful conclusion\halot{with accusative \textbf{make} something \textbf{succeed}, \textbf{bring} something \textbf{to successful conclusion} \haref{Gn}{24}{21}} or not.%%
    \verse{24:22} When the camels had finished drinking, the man took a gold nose-ring\halot{\textbf{ring} \haref{Ex}{35}{22}, nose-ring (of woman) \haref{Gn}{24}{22}, ear-ring (of woman) \haref{Gn}{35}{4}, (of man) \haref{Ex}{32}{2}}\ed{Why would he have a woman's gold nose ring on him?} (its weight was a half-shekel), and two bracelets for her hands (their weight was ten shekels\understood\ of gold),%%
    ...
    \verse{24:25} She also said to him, ``There's tons of straw\halot{chopped stalks, \textbf{straw}, as fodder \haref{Gn}{24}{25}} and fodder\halot{\textbf{fodder}: for camels \haref{Gn}{24}{25\cdot32}} as well\lit{also} with us, as well as room to spend the night.''%%
    \verse{24:26} The man bowed down\halot{\textbf{bow down}, \textbf{kneel down} (always followed by \textit{hi\v sta\d h\super{a}w\^a}) \haref{Gn}{24}{26}} and worshiped the \textsc{Lord}.%%
    \verse{24:27} He said, ``Let the \textsc{Lord}, God of my master Abraham, be blessed, who hasn't abandoned His loving-kindness and His reliability\halot{\textit{\d hesed we'\super{e}met} \textbf{lasting kindness}}\ed{I chose to render this as ``reliability'' to help show that God is the same yesterday, today, and forever.} from my master. I, in the way, the \textsc{Lord} has led me to\understood\ my master's brothers' house.''%%
    ...
    \verse{24:31} He said, ``Come in, you\understood\ blessed of the \textsc{Lord}; why are you standing outside? I've cleared up\ed{Cleaned up?} the house and place for the camels.''%%
    ...
    \verse{24:35} The \textsc{Lord} has greatly blessed my master, and he has become great. He has given him sheep and cattle, silver and gold, servants and maids, camels and donkeys.%%
    ...
    \verse{24:40} And he said to me, `The \textsc{Lord}, whom I continually walk before, will send His messenger\alt{angel} with you, and he will make your way prosper. And you will take a wife for my son from my family, from my father's house.%%
    ...
    \verse{24:42} So I came to the well today, and said, `O \textsc{Lord}, God of my master Abraham, if\ed{probably: please} You make my way successful,\halot{you give success \haref{Gn}{24}{42}} in the way I'm going.'%%
    ...
    \verse{24:44} She said to me, `Both you drink and I will also draw water for your camels.'\lit{Both you drink and also for your camels I will draw.} She is the woman whom the \textsc{Lord} has chosen for my master's son.%%
    ...
    \verse{24:48} I bowed and showed reverence to the \textsc{Lord}, and I blessed the \textsc{Lord}, the God of my master Abraham, who's led me in the way of truth to take my master's niece\lit{brother's daughter} for his son.%%
    ...
    \verse{24:50} Laban and Bethuel answered, and they said, ``The thing has gone out from the \textsc{Lord}. We can't speak good or bad to you.%%
    \verse{24:51} Rebecca is before you: take her\understood\ and go: she will be a wife to your master's son, according as the \textsc{Lord} has spoken.''%%
    \verse{24:52} When Abraham's servant heard their words, he bowed himself to the earth before the \textsc{Lord}.%%
    ...
    \verse{24:56} But he said to them, ``Don't delay me seeing as the \textsc{Lord} has prospered my way. Send me off and I'll go to my master.''%%
    ...
    \pvdb{``You are our sister;}{to thousands may you multiply!}%%
    
    \pvdb{May your posterity possess\footnotemark}{the gate of their enemies!''}%%
    \fntalt{inherit}%%
