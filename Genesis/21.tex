...
\begin{inparaenum}
    ...
    \verse{21:33} And he\ie{Abraham}\ca{prb ins c \sampen\septuagint\peshitta\vulgate\ \Hebrew{אַבְרָהָם}}{probably insert with the Samaritan Pentateuch, Septuagint, Peshitta, and Vulgate ``Abraham''} planted a tamarisk\halot{\textit{Tamarix syriaca}}\ed{Also known as a salt cedar, it's a tree commonly used as a shade tree or wind break.} in Beersheba and there called on the name of the \textsc{Lord}, the eternal God.%% xxxx add figure of tamarisk
