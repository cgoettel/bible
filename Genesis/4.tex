...
\begin{inparaenum}
    ...
    \verse{4:8} Cain said to his brother Abel, ``Let's go into the field.''\ed{Footnote~8a in \textsc{bhs} says, ``mlt Mss Edd hic interv; frt ins c \sampen\septuagint\peshitta\vulgate \Hebrew{נֵלְכָה הַשָּׂדֶה} cf \targum$^\text{J\thinspace J\thinspace I\thinspace I}$ (\textit{many editions of Hebrew manuscripts this interval}).'' This is an exasperated way of saying that many manuscripts contain an omission in \masoretic\ which states ``Let's go into the field.'' See further in Tov 2012 p.\ 221.} So they were in the field and Cain rose up against his brother Abel and killed him.%%
    ...
    {\noindent\verse{4:25} Adam again had intercourse with his wife and she gave birth to a son and called him Seth,\ed{The critical apparatus reads, ``\septuagint(\vulgate) + \Greek{λέγουσα} = \Hebrew{לֵאמֹר}.'' So, according to the Septuagint and the Vulgate, this section should read ``\dots called him Seth, saying\dots.''} ``For God has appointed further offspring to me in Abel's stead''\lit{instead of Abel, for the sake of Abel} (because Cain had murdered Abel).}%%
