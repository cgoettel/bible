...
\begin{inparaenum}
    ...
    \verse{7:11} In the six hundredth year of Noah's life, in the second month, on the seventeenth day of the month, in that day there was\understood\ a breach\halot{a forced breach} of all the fountains\alt{springs} of the great deep\halot{\textbf{primeval ocean}, \textbf{deep} \haref{Gn}{1}{2}\dots\ \textbf{deeps of sea} \haref{Ex}{15}{5} (quasi-mythological)\dots\ \textbf{subterranean water} \haref{Dt}{8}{7}} and the windows\halot{through which rain falls} of the sky were opened.%%
    ...
    \verse{7:21} Every creature that moves\lit{swarms, teems} on the earth died: birds,\lit{of birds; this is true for most of the list.} large animals, animals, every swarming thing\halot{tiny animals occurring in large numbers, in water \haref{Gn}{1}{20}, in air \haref{Lv}{11}{20}, on ground \haref{Gn}{7}{21}.} that swarmed on the earth, and all mankind:%%
