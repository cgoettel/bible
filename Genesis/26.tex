\heading{26}{Isaac and his family go down to live in Gerar per the Lord's instructions~--- Isaac says that his wife is his sister; Abimelech calls him out on it~--- digging of wells and related disputations~--- xxxx}
...
\begin{inparaenum}
    ...
    \verse{26:18} Isaac returned and dug the water wells that they'd\ca{prb 1 c \sampen\septuagint\vulgate\ \Hebrew{עַבְדֵי} cf 15.19.25 et \peshitta\targum\super{J}}{probably one with the Samaritan Pentateuch, Septuagint, and Vulgate which have ``servants'' [in construct, so ``his father Abraham's servants'']; compare verses~15, 19, and~25 and the Peshitta and Targum} dug in the days of his father, Abraham, which the Philistines had stopped after Abraham's death. He named them\lit{called their names after} after the names his father had called them.%%
    ...
    \verse{26:28} They said, ``We've definitely seen that the \textsc{Lord} is with you; so we say, `Please let there be a covenant between us\ca{\missing\ Vrs, dl?}{[``between us'' is] missing in multiple versions, deleted?} and you\lit{between you} so let us make a covenant with you:%% Keep "\lit{between you}" because it matters in the context of the critical apparatus note.
