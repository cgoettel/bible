\section{Names of the Lord}\label{app:names-of-the-lord}\thispagestyle{fancy}
...
This practice continued through the 5\textsuperscript{th} and 6\textsuperscript{th} centuries \textsc{ad}. It is still considered sacrilegious by very observant Jews, so much so that even \Hebrew{אֱלוֺהִים} is pronounced by Hasidic Jews as \Hebrew{אֱלוֺקִים}. In writing, ``G-d'' or ``G\_{}d'' is substituted for ``God.'' However, this practice is not peculiar to Judaism as Parley P.\ Pratt would write ``G-d'' when quoting blasphemers.
