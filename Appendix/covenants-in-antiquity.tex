\section{Covenants in Antiquity}\label{app:covenants-in-antiquity}\thispagestyle{fancy}
...
BH does not have a sense of knowing a person, like the French \emph{conna\^\i tre}. The closest to that sense is \Hebrew{נכר} which means, in the hiphil, \emph{to be acquainted}.
